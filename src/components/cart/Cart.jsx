...
export default function Cart({ selectCourses }) {
    ...
    return (
        <div className="w-full lg:w-auto bg-white rounded-xl h-fit my-4 lg:my-0">
            <h1 className="text-primary font-bold text-lg lg:text-center py-4 ml-4 lg:ml-0">Credit Hour Remaining {remaining} hr</h1>
            <hr className="border lg:w-11/12 mx-auto" />
